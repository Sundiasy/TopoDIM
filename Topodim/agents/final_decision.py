...
class FinalWriteCode(Node):
    ...
    def _process_inputs(self, raw_inputs:Dict[str,str], spatial_info:Dict[str,Any], temporal_info:Dict[str,Any], query_info:Dict[str,Any] = {}, debate_info:Dict[str,Any] = {}, evaluation_info:Dict[str,Any] = {}, **kwargs)->List[Any]:
